...
const Agent = mongoose_1.default.models.Agent || mongoose_1.default.model('Agent', agentSchema);
// Thêm đại lý mới
router.post('/add', async (req, res) => {
    ...
    if (existed)
        return res.status(400).json({ success: false, message: 'Tên đại lý đã tồn tại' });
...
router.post('/:id/deposit', async (req, res) => {
    ...
    const AgentTransaction = mongoose_1.default.models.AgentTransaction || require('../../models/agentTransaction.model').default;
